...
- Shortcut hints: `<kbd class="mws-data mws-data--kbd">` — 12pt mono, `--text-secondary`, 1px `--border-light` keycap border, 2px radius. The class is the only legal way to set the font (`_core-requirements.md`, rule 7).
